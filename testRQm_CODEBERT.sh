...
do
echo $trainset
CUDA_VISIBLE_DEVICES=0 python ./utils/runlora.py \
--output_folder_name=CODEBERTRQm_$trainset \
...
--seed 1 2>&1 | tee "testRQm_CODEBERT_$(echo $trainset | sed s@/@-@g)_$(echo $trainset | sed s@/@-@g).log"
done