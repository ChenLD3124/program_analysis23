...
for trainset in "bugtype_buffer_overflow" "bugtype_input_validation" "bugtype_privilege_escalation_authorization" "bugtype_resource_allocation_free" "bugtype_value_propagation_errors"
do
echo $trainset
CUDA_VISIBLE_DEVICES=1 python ./utils/runlora.py \
--output_folder_name=CODEBERTRQl_bugtype_mixed  \
